 ...
 */
package com.unicauca.pay.crudproducts.plugin.paypal;
 ...
 * @author JUAN DAVID
 */
public class PluginPaypal implements iPayPlugin{
    String filePath;
    @Override
    public boolean paySimulated(PayCrudProducts pago) {
        this.filePath = "datosCuentaPaypal.txt"; // Nombre del archivo sin la ruta completa
