...
public class GUIStore extends javax.swing.JDialog{
     ...
     */
    public GUIStore(ProductService productService, CarritoService carritoService) {
    ...
    private void initComponents() {
        ...
        btnAddCarrito.setIcon(new javax.swing.ImageIcon(getClass().getResource("/icons/car.png"))); // NOI18N
        btnAddCarrito.setText(" Agregar Carrito");
        btnAddCarrito.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnAddCarritoActionPerformed(evt);
            }
        });
        jPanel1.add(btnAddCarrito);
    ...
    private void btnCloseActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCloseActionPerformed
        this.dispose();
        GUIUserMen pMen = new GUIUserMen(productService,categoryService);
    ...
    private void btnAddCarritoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAddCarritoActionPerformed
        ...
        /*CON EL METODO GET_SELECTED_ITEM*/
    ...
    private void fillOnlyTable(Product prmProduct)
    {
        ...
        rowData[2] = prmProduct.getDescription();
        rowData[3] = prmProduct.getPrice();
        /*for (Category category : prmProduct.getCategory()) {
            rowData[3] = category.getCategoryName() + " ";
        }*/
