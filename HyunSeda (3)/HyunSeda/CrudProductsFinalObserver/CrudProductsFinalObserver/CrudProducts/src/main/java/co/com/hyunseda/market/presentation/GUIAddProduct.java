...
public class GUIAddProduct extends javax.swing.JFrame {
    ...
    private void addProduct() {
        ...
        /*´POR CADA SELECTED, AGREGARLAS A UN ARREGLO AUXILIAR*/
        /*eSE ARREGLO SE PASA A PRODUCT SERVICE*/
        ...
        if (productService.saveProduct(idProduct,name,description,price,categories))/*productService.saveProduct(name, description)*/ {
            ...
            /*CODIGO DONDE SE AVERIGUE EL ID DEL PRODUCTO GUARDADO
                    
                Select idProduct from Product where name = name,description = description, price = price, categories = categories
                Select MAX(idProduct) as idProductoMax from Product --> Tambien se envia a categorias 
            */
