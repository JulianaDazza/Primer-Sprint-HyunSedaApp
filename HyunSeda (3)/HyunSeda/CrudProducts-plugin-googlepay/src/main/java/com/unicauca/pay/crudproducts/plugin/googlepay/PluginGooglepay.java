 ...
 */
package com.unicauca.pay.crudproducts.plugin.googlepay;
 ...
 * @author JUAN DAVID
 */
public class PluginGooglepay implements iPayPlugin{
    String filePath;
    @Override
    public boolean paySimulated(PayCrudProducts pago) {
        this.filePath = "datosCuentaGoogle.txt"; // Nombre del archivo sin la ruta completa
